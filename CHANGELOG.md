...
- Published to the npm registry on 2026-06-19T23:52:11Z (UTC) with `--provenance`, carrying a SLSA provenance v1 attestation generated by GitHub Actions over OIDC. Consumers can verify with `npm view @takk/bayestruth --json | jq .dist.attestations`.
